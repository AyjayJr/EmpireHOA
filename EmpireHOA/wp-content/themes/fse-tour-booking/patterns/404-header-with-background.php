<?php
  ...
  * Slug: fse-tour-booking/404-header-with-background
  */
?>
...
<div class="wp-block-cover is-light" style="margin-bottom:var(--wp--preset--spacing--60)"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo get_parent_theme_file_uri( '/assets/images/banner.png' ); ?>" data-object-fit="cover"/>
...
<p class="has-text-align-center has-foreground-color has-text-color has-content-heading-font-size"><?php esc_html_e('Oops! That page cannot be found','fse-tour-booking'); ?></p>
<!-- /wp:paragraph -->
